      ...
      <div className="flex justify-center items-center grow">
        <div className="bg-slate-200 rounded-lg w-[50%] py-5 flex flex-col justify-center items-center">
          <img
            ...
            src={
              "https://res.cloudinary.com/djcn6luvw/image/upload/v1696846424/internal_server_error_afeify_1_c0mgny.png"
            }
            alt="something went wrong"
          />
          <h2 className="mt-10 text-lg">Oops! Something went wrong...</h2>
          <Link
